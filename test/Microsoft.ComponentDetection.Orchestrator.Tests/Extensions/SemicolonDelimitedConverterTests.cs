...
[TestClass]
public class SemicolonDelimitedConverterTests
{
    private readonly SemicolonDelimitedConverter converter;

    public SemicolonDelimitedConverterTests() => this.converter = new SemicolonDelimitedConverter();
