...
public class DefaultGraphTranslationService : ServiceBase, IGraphTranslationService
{
    ...
    private static DetectedComponent MergeComponents(IEnumerable<DetectedComponent> enumerable)
    {
    ...
    private static ScannedComponent ConvertToContract(DetectedComponent component)
    {
    ...
    private static List<DetectedComponent> FlattenAndMergeComponents(IEnumerable<DetectedComponent> components)
    {
