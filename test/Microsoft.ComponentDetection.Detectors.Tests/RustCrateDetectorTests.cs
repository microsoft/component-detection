...
namespace Microsoft.ComponentDetection.Detectors.Tests
{
    ...
    public class RustCrateDetectorTests
    {
        ...
        public async Task TestSupportsCargoV1AndV2DefinitionPairs()
        {
            ...
            var (result, _) = await detectorTestUtility
                                                    /* v1 files */
                                                    .WithFile("Cargo.lock", testCargoLockString)
                                                    /* v2 files */
...
";
        ...
        {
            await TestRustDetector_WorkspacesWithTopLevelDependencies(testWorkspaceLockV1NoBaseString);
        }

        [TestMethod]
        public async Task TestRustDetector_V2WorkspacesWithTopLevelDependencies()
        {
            await TestRustDetector_WorkspacesWithTopLevelDependencies(testWorkspaceLockV2NoBaseString);
        }
        ...
        {
            await TestRustDetector_WorkspacesNoTopLevelDependencies(testWorkspaceLockV1NoBaseString);
        }

        [TestMethod]
        public async Task TestRustDetector_V2WorkspacesNoTopLevelDependencies()
        {
            await TestRustDetector_WorkspacesNoTopLevelDependencies(testWorkspaceLockV2NoBaseString);
        }
        ...
        {
            await TestRustDetector_WorkspacesWithSubDirectories(testWorkspaceLockV2NoBaseString);
        }
