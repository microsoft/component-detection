...
public class DetectorProcessingServiceTests
{
    ...
    public DetectorProcessingServiceTests()
    {
        ...
        // Setup path utility to return the same path by default (no symlinks)
        this.pathUtilityServiceMock.Setup(x => x.ResolvePhysicalPath(It.IsAny<string>()))
            .Returns<string>(path => path);

        this.serviceUnderTest =
            new DetectorProcessingService(this.directoryWalkerFactory.Object, this.pathUtilityServiceMock.Object, this.experimentServiceMock.Object, this.loggerMock.Object, this.consoleMock.Object);
    ...
    public async Task ProcessDetectorsAsync_WithMavenDetectors_ShouldCleanupMavenFilesAfterAllDetectorsFinish()
    {
        ...
        // Use bcde.mvndeps - the specific filename generated by MavenCommandService
        var testFile1 = Path.Combine(tempDir, "bcde.mvndeps");
        var testFile2 = Path.Combine(tempDir, "subdir", "bcde.mvndeps");
    ...
    public async Task ProcessDetectorsAsync_WithoutMavenDetectors_ShouldNotCleanupMavenFiles()
    {
        ...
        // Use bcde.mvndeps - the specific filename generated by MavenCommandService
        var testFile = Path.Combine(tempDir, "bcde.mvndeps");
