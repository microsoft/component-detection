...
public sealed class SimplePyPiClient : ISimplePyPiClient, IDisposable
{
    ...
    private readonly SimplePypiCacheTelemetryRecord cacheTelemetry;
    ...
    public SimplePyPiClient() => this.cacheTelemetry = new SimplePypiCacheTelemetryRecord()
    {
        NumProjectFileCacheHits = 0,
        NumSimpleProjectCacheHits = 0,
        FinalProjectFileCacheSize = 0,
        FinalSimpleProjectCacheSize = 0,
    };
    ...
    public SimplePyPiClient(IEnvironmentVariableService environmentVariableService, ILogger<SimplePyPiClient> logger)
    {
        ...
        this.cacheTelemetry = new SimplePypiCacheTelemetryRecord
        {
            NumProjectFileCacheHits = 0,
            NumSimpleProjectCacheHits = 0,
            FinalProjectFileCacheSize = 0,
