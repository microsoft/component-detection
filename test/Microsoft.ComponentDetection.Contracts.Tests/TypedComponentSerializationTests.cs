...
namespace Microsoft.ComponentDetection.Contracts.Tests
{
    ...
    public class TypedComponentSerializationTests
    {
        ...
        {
            TypedComponentNS.TypedComponent tc = new OtherComponent("SomeOtherComponent", "1.2.3", new Uri("https://sampleurl.com"), "SampleHash");
            var result = JsonConvert.SerializeObject(tc);
            var deserializedTC = JsonConvert.DeserializeObject<TypedComponentNS.TypedComponent>(result);
        ...
        public void TypedComponent_Serialization_NuGet()
        {
            ...
            TypedComponentNS.TypedComponent tc = new NuGetComponent(testComponentName, testVersion, testAuthors);
            var result = JsonConvert.SerializeObject(tc);
            var deserializedTC = JsonConvert.DeserializeObject<TypedComponentNS.TypedComponent>(result);
        ...
        {
            TypedComponentNS.TypedComponent tc = new NpmComponent("SomeNpmComponent", "1.2.3", "sha1-placeholder");
            var result = JsonConvert.SerializeObject(tc);
            var deserializedTC = JsonConvert.DeserializeObject<TypedComponentNS.TypedComponent>(result);
            deserializedTC.Should().BeOfType(typeof(NpmComponent));
            var npmComponent = (NpmComponent)deserializedTC;
        ...
        {
            TypedComponentNS.TypedComponent tc = new MavenComponent("SomeGroupId", "SomeArtifactId", "1.2.3");
            var result = JsonConvert.SerializeObject(tc);
            var deserializedTC = JsonConvert.DeserializeObject<TypedComponentNS.TypedComponent>(result);
        ...
        {
            TypedComponentNS.TypedComponent tc = new GitComponent(new Uri("http://some.com/git/url.git"), "SomeHash");
            var result = JsonConvert.SerializeObject(tc);
            var deserializedTC = JsonConvert.DeserializeObject<TypedComponentNS.TypedComponent>(result);
        ...
        {
            TypedComponentNS.TypedComponent tc = new RubyGemsComponent("SomeGem", "1.2.3", "SampleSource");
            var result = JsonConvert.SerializeObject(tc);
            var deserializedTC = JsonConvert.DeserializeObject<TypedComponentNS.TypedComponent>(result);
        ...
        {
            TypedComponentNS.TypedComponent tc = new CargoComponent("SomeCargoPackage", "1.2.3");
            var result = JsonConvert.SerializeObject(tc);
            var deserializedTC = JsonConvert.DeserializeObject<TypedComponentNS.TypedComponent>(result);
        ...
        {
            TypedComponentNS.TypedComponent tc = new PipComponent("SomePipPackage", "1.2.3");
            var result = JsonConvert.SerializeObject(tc);
            var deserializedTC = JsonConvert.DeserializeObject<TypedComponentNS.TypedComponent>(result);
        ...
        {
            TypedComponentNS.TypedComponent tc = new GoComponent("SomeGoPackage", "1.2.3", "SomeHash");
            var result = JsonConvert.SerializeObject(tc);
            var deserializedTC = JsonConvert.DeserializeObject<TypedComponentNS.TypedComponent>(result);
        ...
        {
            TypedComponentNS.TypedComponent tc = new DockerImageComponent("SomeImageHash", "SomeImageName", "SomeImageTag");
            var result = JsonConvert.SerializeObject(tc);
            var deserializedTC = JsonConvert.DeserializeObject<TypedComponentNS.TypedComponent>(result);
        ...
        {
            TypedComponentNS.TypedComponent tc = new PodComponent("SomePodName", "SomePodVersion", "SomeSpecRepo");
            var result = JsonConvert.SerializeObject(tc);
            var deserializedTC = JsonConvert.DeserializeObject<TypedComponentNS.TypedComponent>(result);
        ...
        {
            TypedComponentNS.TypedComponent tc = new LinuxComponent("SomeLinuxDistribution", "SomeLinuxRelease", "SomeLinuxComponentName", "SomeLinuxComponentVersion");
            var result = JsonConvert.SerializeObject(tc);
            var deserializedTC = JsonConvert.DeserializeObject<TypedComponentNS.TypedComponent>(result);
